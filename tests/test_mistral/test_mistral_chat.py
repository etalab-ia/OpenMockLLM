...
def test_chat_completion_sync_streaming(mistral_client):
...
def test_chat_completion_audio_transcription(mistral_client):
    """Test audio transcription"""

    audio_base64 = "SUQzBAAAAAAAI1RTU0UAAAAPAAADTGF2ZjYwLjE2LjEwMAAAAAAAAAAAAAAAtUAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
    response = mistral_client.chat.complete(
        model="openmockllm",
        messages=[
            {
